...
replies = {
    #in help , we have to insert all the commands and their short intro , and also link to discord at last (if they have any other issue)
    ...
    #in below 2 commands we have to insert variable called username 
    "/start_new_user": "🎉 Welcome aboard the IIT Madras BSc adventure! 🚀  🙌 \nCan you tell me in which level you are?",

    #in these we should give him list of commands he can use and short info about them (notes and pyq as of now , and also change subjects)
